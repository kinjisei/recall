// ============================================================================
// Просмотр слов набора + выборочное назначение (карточка ученика у
...
// (lib/teacher.assignSelectedWords) и назначит её ученику.
// ============================================================================
...
export function DeckWordsPicker({
  ...
  const assignSelected = async () => {
    ...
    try {
      ...
      setNotice(`Назначено слов: ${added} — набор-выборка появился у ученика`)
      setChecked(new Set())
      onAssigned()
    } catch (e) {
