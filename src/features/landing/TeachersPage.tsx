...
const FAQ = [
  ...
  {
    q: 'Что будет после 14 дней триала?',
    a: 'Ничего не списывается — карту мы не просим. Понравится — оплатишь Kaspi-переводом; нет — данные останутся, вернёшься когда угодно.',
  },
  {
