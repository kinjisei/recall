...
// 3900/6500/14990₸ (энергия E4), триал 14 дней без карты, «приведи коллегу» (2 недели —
...
const TOOLS: { Icon: IconLike; title: string; desc: string }[] = [
  {
    ...
    desc: 'Задай тему и уровень — AI составит текст с упражнениями под конкретного ученика. Печать в PDF или назначение прямо в приложении.',
  },
  {
    Icon: IconCheck,
      ...
      <div className="mx-auto max-w-screen-md px-5 pb-16">
        ...
        <section className="border-t border-white/[0.06] py-10">
          ...
          <div className="mt-6 flex flex-col gap-3">
            {[
              ['Пригласи ученика кодом', 'Он вводит код на своей Главной — и вы связаны. Никаких настроек.'],
        ...
        <section className="border-t border-white/[0.06] py-10">
          <div className="rounded-2xl border border-[var(--night-accent-30)] bg-[rgba(145,132,217,.07)] p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--night-text-70)]">
              ...
              забываться, — ученику не нужно решать, что учить сегодня. Плюс
