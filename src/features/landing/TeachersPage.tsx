...
// 3000/5000/12000₸, триал 14 дней без карты, «приведи коллегу».
...
const TOOLS: { Icon: IconLike; title: string; desc: string }[] = [
  ...
  },
  {
    ...
    desc: 'Красивый PDF: динамика, сильные стороны, фокус месяца. Родители видят прогресс — и продлевают занятия.',
  },
]
...
const FAQ = [
  {
    ...
    a: 'Нет. Пока у тебя активный тариф, все твои ученицы пользуются приложением бесплатно, включая AI.',
  },
  {
    q: 'Что будет после 14 дней пробного периода?',
    a: 'Ничего не списывается — карту мы не просим. В пробные две недели открыты все разделы и 12 ответов AI в день; понравится — оплатишь Kaspi-переводом и лимит вырастет до 200. Нет — данные останутся, вернёшься когда угодно.',
  },
  {
      ...
      <div className="mx-auto max-w-screen-md px-5 pb-16">
        ...
        <section className="flex flex-col items-center gap-6 pb-12 pt-10 text-center">
          ...
          <p className="max-w-lg text-[15px] leading-relaxed text-[var(--night-text-60)]">
            Recall — рабочий кабинет репетитора: материалы с упражнениями за минуты,
            проверка с AI-черновиком, живая диагностика каждой ученицы и отчёты,
            которые продлевают занятия. Дешевле одного часа твоей работы в месяц.
          </p>
          <CTA />
        ...
        <section className="border-t border-white/[0.06] py-10">
          <div className="rounded-2xl border border-[var(--night-accent-30)] bg-[rgba(145,132,217,.07)] p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--night-text-70)]">
              Внутри — полноценное приложение для самостоятельных занятий: умные повторения
              слов (алгоритм FSRS), 60 уроков грамматики A1–C1, 476 фразовых глаголов,
              911 идиом, тексты с тап-словарём, оценка произношения и AI-диалоги с
              исправлением ошибок. 15 минут в день в приложении дают больше, чем час раз
              в неделю — и это видно в твоей диагностике.
            </p>
          </div>
        </section>
        ...
        <section className="border-t border-white/[0.06] py-10">
          ...
          <p className="mt-3 text-center text-xs text-[var(--night-text-40)]">
            Для сравнения: аналоги берут ~1 000 ₸ за ученика. Приведи коллегу — обоим месяц бесплатно.
          </p>
          <div className="mt-6">
