    ...
    <main className="mx-auto min-h-[100dvh] max-w-screen-sm bg-[var(--night-bg)] px-5 pb-16 pt-[calc(env(safe-area-inset-top)+1.5rem)] text-[var(--night-text)]">
      ...
      <section className="animate-fade-up mt-8 rounded-2xl border border-white/[0.08] bg-[var(--night-surface)] p-4">
        ...
        <p className="mt-3 text-sm leading-relaxed text-[var(--night-text-70)]">
          ...
          дальше — 15 ⚡. Энергию тратят разговоры с AI: реплика в «Диалоге» и ход
          в квесте — 1 ⚡, проверка письма — 2 ⚡. Перевод слов по тапу и
          произношение энергию не тратят, у них свой суточный запас, которого
          хватает с большим запасом (на пробном периоде — по 150 в день).
          Повторение карточек, игры и грамматика не ограничены ничем. Карта не
          нужна. Репетитору на пробном периоде доступны 2 AI-генерации — ровно
          один материал целиком, чтобы увидеть качество своими глазами.
        </p>
      </section>
    </main>
  )
