      ...
      {loading ? (
        ...
        <>
          <Card className="items-center text-center">
            ...
            {totalWords === 0 ? (
              // Кнопка ведёт ТУДА, ЧТО ОБЕЩАЕТ: раньше это был корень «Учёбы»,
              // и до самих слов оставалось ещё два тапа — человек с пустой
              // колодой упирался в хаб и не понимал, куда идти (замер ревью 1Б).
