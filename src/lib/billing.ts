...
export const PLANS: PlanCard[] = [
  ...
  },
  {
    ...
    price: 3900,
    tagline: 'Первые ученицы, проба режима',
    studentLimit: 5,
    features: [
      'Материалы, задания, проверка работ, AI-квесты',
      'Ученицы занимаются с AI бесплатно (общая энергия студии)',
  ...
  },
  {
    ...
    price: 6500,
    tagline: 'Когда учениц уже группа',
    studentLimit: 10,
    features: ['Всё из Mini', 'До 10 учениц одновременно', 'До 45 материалов и программ в месяц'],
  },
  {
    id: 'teacher_pro',
    title: 'Репетитор · Pro',
    ...
    studentLimit: 30,
    features: ['Всё из Mini', 'До 30 учениц одновременно', 'До 90 материалов и программ в месяц'],
  },
]
