...
try {
  ...
  spawn(
    ...
    [
      ...
      `--user-data-dir=${profileDir('recall-idioms-smoke')}`,
      '--no-first-run',
      'about:blank',
    ],
  ...
  try {
    ...
    // Уровни в паках свёрнуты; поиск раскрывает всё сразу — так проверка не
    // зависит от того, в какой категории лежат идиомы и как назван уровень.
